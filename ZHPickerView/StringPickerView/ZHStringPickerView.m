...
@interface ZHStringPickerView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@property (nonatomic, copy) ZHStringResultBlock resultBlock;
// 单列选中的项
...
@implementation ZHStringPickerView
...
+ (void)showStringPickerWithTitle:(NSString *)title
    ...
    ZHStringPickerView *strPickerView = [[ZHStringPickerView alloc]initWithTitle:title dataSource:dataSource defaultSelValue:defaultSelValue isAutoSelect:isAutoSelect resultBlock:resultBlock];
