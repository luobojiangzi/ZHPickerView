...
/** 姓名 */
@property (nonatomic, strong) ZHTextField *nameTF;
/** 性别 */
@property (nonatomic, strong) ZHTextField *genderTF;
/** 出生年月 */
@property (nonatomic, strong) ZHTextField *birthdayTF;
/** 出生时刻 */
@property (nonatomic, strong) ZHTextField *birthtimeTF;
/** 联系方式 */
@property (nonatomic, strong) ZHTextField *phoneTF;
/** 地区 */
@property (nonatomic, strong) ZHTextField *addressTF;
/** 学历 */
@property (nonatomic, strong) ZHTextField *educationTF;
/** 其它 */
@property (nonatomic, strong) ZHTextField *otherTF;
...
- (ZHTextField *)getTextField:(UITableViewCell *)cell {
    ZHTextField *textField = [[ZHTextField alloc]initWithFrame:CGRectMake(SCREEN_WIDTH - 230, 0, 200, 50)];
...
- (void)setupGenderTF:(UITableViewCell *)cell {
    if (!_genderTF) {
        ...
        _genderTF.tapAcitonBlock = ^{
            [ZHStringPickerView showStringPickerWithTitle:@"宝宝性别" dataSource:@[@"男", @"女", @"其他"] defaultSelValue:@"男" isAutoSelect:YES resultBlock:^(id selectValue) {
...
- (void)setupBirthtimeTF:(UITableViewCell *)cell {
    if (!_birthtimeTF) {
        ...
        _birthtimeTF.tapAcitonBlock = ^{
            [ZHDatePickerView showDatePickerWithTitle:@"出生时刻" dateType:UIDatePickerModeTime defaultSelValue:weakSelf.birthtimeTF.text minDateStr:@"" maxDateStr:@"" isAutoSelect:YES resultBlock:^(NSString *selectValue) {
